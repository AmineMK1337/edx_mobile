...
class _StudentHomeState extends State<StudentHome> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = viewModel.isLoading
        ? 'Chargement...'
      ...
      children: [
        buildMenu(context, "Note d’info", Icons.description, onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const NoteInfoScreen()));
        }),
        ...
        buildMenu(context, "Absences", Icons.event_busy, onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const AbsencesScreen()));
        }),
        ...
        buildMenu(context, "Emploi", Icons.calendar_today, onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (_) => const EmploiScreen()));
        }),
        ...
        buildMenu(context, "Partage", Icons.share, onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const PartageDocumentsPage()));
        }),
    ...
    return RoleHomeLayout(
      titleText: 'ESPACE ÉTUDIANT',
      userName: displayName.isEmpty ? 'Étudiant' : displayName,
      userRoleDisplay: 'Étudiant',
      stats: const <RoleStat>[],
      menuGrid: grid,
